...
import { Form, UserLine, DeleteUserBtn, SearchBox } from "../Styles/styled";
    ...
    <>
      ...
      <Form>
        ...
        {props.users.map((userData) => {
          return (
            <UserLine>
              <p key={Date.now()} onClick={props.userDetails}>
                {userData.name}
              </p>
              <div className="iconsBox">
                <img
                  onClick={() => props.userDetails(userData)}
                ...
                />
                <DeleteUserBtn onClick={() => props.deleteUser(userData)}>
                  X
                </DeleteUserBtn>
              </div>
            </UserLine>
