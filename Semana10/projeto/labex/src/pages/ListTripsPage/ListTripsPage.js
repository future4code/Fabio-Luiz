...
import { Wrapper, TextBox, Icon, SideMenu, OpenBox } from "./styled";
import { VideoBG } from "./../../components/globalStyled";
...
const ListTripsPage = () => {
  ...
  return (
    <>
      ...
      <Icon onClick={toggle} openMenu={openMenu}>
        <div>Menu</div>
        <img
      ...
      <Wrapper onClick={() => setOpenMenu(false)}>
        {targetTrip ? (
          <>
            <div>
              {targetTrip && (
